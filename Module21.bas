...
Dim UidString As String
    ...
    For i = N_rows - 549 To N_rows 'N_rows
        ...
        LocationString = "LOCATION:" + CStr(CalendarData(i, Latitude)) + "," + CStr(CalendarData(i, Longitude))
        
        Dim DescriptionString As String
        DescriptionString = "DESCRIPTION:" ' + "Percentage " + CStr(CalendarData(i, Percent) * 100) + "%"
        
        For j = 1 To 44
            DescriptionString = DescriptionString + CStr(CalendarData(0, j)) + ": " + "\n" + "     " + CStr(CalendarData(i, j)) + "\n"
        Next j
...
vFTPServ = "nickisverygood.dlinkddns.com"

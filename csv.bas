...
Public Function ArrayFromCSVfile( _
 ...
 Function Join2d(ByRef InputArray As Variant, Optional RowDelimiter As String = vbCr, Optional FieldDelimiter = vbTab, Optional SkipBlankRows As Boolean = False) As String

...
'            If init = False Then
'                durS = Range(use_Structured(cell, 3)).Value2
'                durL = Range(use_Structured(cell, 3)).Value2
'                init = True
'            End If
'            If Range(use_Structured(cell, 3)).Value2 > durL Then durL = Range(use_Structured(cell, 3)).Value2
'            If Range(use_Structured(cell, 3)).Value2 < durS Then durS = Range(use_Structured(cell, 3)).Value2
'        Next cell
'
        For Each cell In selected
